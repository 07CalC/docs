...
description: "fyrer is a fast, language-agnostic monorepo task runner that resolves task dependencies into a DAG, runs levels concurrently, caches builds, and streams colorized logs."
---
