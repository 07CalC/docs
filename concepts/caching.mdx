---
title: "Build Caching in fyrer: Skip Unchanged Tasks"
...
- **`cache: true` + `watch: true`** — Watch-mode tasks restart on file changes and don't have a single deterministic "done" state to cache.
