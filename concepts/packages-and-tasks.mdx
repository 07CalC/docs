---
title: "Packages and Tasks: fyrer's Building Blocks"
...
- Tasks can declare `inputs`, `outputs`, `depends_on`, `cache`, `persistent`, `watch`, `timeout`, `cwd`, and per-task `env` / `env_file`.
