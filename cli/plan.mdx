---
title: "fyrer plan — Preview the Task Execution Graph"
sidebarTitle: "plan"
description: "fyrer plan resolves the task dependency graph and prints the execution order without running anything, so you can verify dependencies are wired correctly before a run."
---
