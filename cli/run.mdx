---
title: "fyrer run — Execute Tasks and Stream Logs"
sidebarTitle: "run"
description: "fyrer run executes tasks from your fyrer.yml, resolves the dependency graph, runs tasks concurrently, and streams output to an interactive TUI or plain log mode."
---
